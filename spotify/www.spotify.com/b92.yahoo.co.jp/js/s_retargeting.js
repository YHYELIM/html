! function(r) {
    ...
    e.m = r, e.c = t, e.d = function(r, t, n) {
        ...
        if (e.r(n), Object.defineProperty(n, "default", {
            ...
            for (var o in r) e.d(n, o, function(t) {
                return r[t]
            }.bind(null, o));
        return n
    }, e.n = function(r) {
    ...
    function n(r, t) {
        ...
        if (!e) {
            if (Array.isArray(r) || (e = function(r, t) {
                    ...
                    if ("Arguments" === e || /^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(e)) return o(r, t)
    ...
    var a = e(2),
        i = function(r) {
            for (var t = /^\s*_ycl_yjad=\s*(.*?)\s*$/, e = r.split(";"), n = 0; n < e.length; ++n) {
                var o = t.exec(e[n]);
                if (o && 2 === o.length) {
        ...
        l = function(r) {
            for (var t = [], e = [], n = [], o = [], a = 0, i = r.length; a < i; a++) t.push([r[a].item_id]), e.push([r[a].category_id]), n.push([r[a].price]), o.push([r[a].quantity]);
            return {
                itemId: t.join(","),
                categoryId: e.join(","),
                price: n.join(","),
        ...
        s = function(r, t) {
            var e, n, o;
            return o = r.location.protocol + "//" + r.location.host + r.location.pathname + r.location.search, r === r.parent ? (e = o, n = t.referrer) : ((e = t.referrer) || (e = o), n = ""), {
                ref: e,
                rref: n
            }
        },
        ...
        g = function(r) {
            return !!(r.navigator && r.navigator.userAgentData && r.navigator.userAgentData.getHighEntropyValues)
        },
        p = function(r) {
            return new r.Promise((function(t) {
                r.navigator.userAgentData.getHighEntropyValues(["platform", "platformVersion", "fullVersionList"]).then((function(r) {
                    try {
                        var e = "";
                        e += "brands=" + encodeURIComponent(function(r) {
                            for (var t = "", e = 0; e < r.length; ++e) 0 !== e && (t += ", "), t += h(r[e].brand) + "; v=" + h(r[e].version);
                            return t
                        }(r.fullVersionList)), e += "&platform=" + encodeURIComponent(h(r.platform)), e += "&platform_version=" + encodeURIComponent(h(r.platformVersion)), t(e)
                    } catch (r) {
                        t("")
                    }
                })).catch((function(r) {
    ...
    r.exports = {
        mark: function(r, t, e) {
            ...
            var h = e.yahoo_retargeting_id || "",
                ...
                A = S.rref,
                R = [];
            R.push("p=" + encodeURIComponent(h)), R.push("label=" + encodeURIComponent(d)), R.push("ref=" + a.encodeURL(j)), R.push("rref=" + a.encodeURL(A)), R.push("pt=" + encodeURIComponent(v)), R.push("item=" + encodeURIComponent(b)), R.push("cat=" + encodeURIComponent(C)), R.push("price=" + encodeURIComponent(w)), R.push("quantity=" + encodeURIComponent(I));
            var U = R.join("&");
            if (!Object.prototype.hasOwnProperty.call(r.yahoo_retargeting_sent_urls_counter, U)) {
                ...
                var M = i(t.cookie);
                M && R.push("yclid=" + M), m && R.push("_impl=" + encodeURIComponent(m));
                var O = function(r) {
                ...
                if (r.Promise) {
                    var P = [];
                    g(r) && P.push(p(r)), 0 !== P.length ? r.Promise.all(P).then((function(r) {
                        var t, e = n(r);
                        try {
                            for (e.s(); !(t = e.n()).done;) {
                                var o = t.value;
    ...
    r.exports = (e = function(r) {
        ...
        for (t = 0, e = r.length, a = i = 0; t < e; t++)
            if (45 != (o = r.charCodeAt(t)) && o < 48 || o > 57 && o < 65 || o > 90 && o < 97 || o > 122 && o <= 255) {
                if (0 != a) {
            ...
            } else 0 == a && (f += r.substr(i, t - i), i = t, a = 1), o > 255 && (a = 2);
        ...
        var n;
        for (r = e ? Math.floor(r / 700) : r >> 1, r += Math.floor(r / t), n = 0; r > 455; n += 36) r = Math.floor(r / 35);
        return Math.floor(n + 36 * r / (r + 38))
    }, i = function(r) {
        for (var t = new Array, e = 128, n = 0, i = 72, u = 0; u < r.length; ++u) r[u] < 128 && t.push(r[u]);
        var f = t.length,
            c = f;
            ...
            for (n += (l - e) * (c + 1), e = l, u = 0; u < r.length; ++u) {
                ...
                if (r[u] == e) {
                    for (var s = n, h = 36;; h += 36) {
                        ...
                        if (s < g) break;
                        t.push(o(g + (s - g) % (36 - g))), s = Math.floor((s - g) / (36 - g))
                    }
        ...
        for (var t, e = "", n = 0; n < r.length; n++)(t = r.charCodeAt(n)) <= 127 ? e += r.charAt(n) : t >= 128 && t <= 2047 ? (e += String.fromCharCode(t >> 6 & 31 | 192), e += String.fromCharCode(63 & t | 128)) : (e += String.fromCharCode(t >> 12 | 224), e += String.fromCharCode(t >> 6 & 63 | 128), e += String.fromCharCode(63 & t | 128));
        return e
    }, {
        encodeURL: function(r) {
            var t, n, o, a, i = "",
                f = "";
            for (t = 0, n = r.length, a = 0; t < n && 47 != (o = r.charCodeAt(t)); t++) 0 == a && (o < 65 || o > 90 && o < 97 || o > 122) && (t + 3 < n && "://" == r.substr(t, 3) && (t += 2), a = 1);
            if (0 != t) {
                if ("" == (a = e(r.substr(0, t)))) return ""
            } else a = "";
            for (n != t && (a += u(r.substr(t, n - t))), t = 0, n = (i = a).length; t < n; t++) f += (o = i.charCodeAt(t)) <= 126 ? i.charAt(t) : "%" + (a = "0" + o.toString(16)).substr(a.length - 2, 2);
