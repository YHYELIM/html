/*!
 * kakao-pixel-web v0.13.0 | (c) 2018 Kakao Corp.
 * @generated 2023-05-03 10:47:22
 */
! function(e) {
    function t(r) {
                        ...
                        var A = {
                            ...
                            I = function j(e, t, n, r, o, i, a) {
                                ...
                                if ("object" == (void 0 === c ? "undefined" : u(c)) && c)
                                    ...
                                    if (C) {
                                        for (l = w(c / 864e5), f = w(l / 365.2425) + 1970 - 1; C(f + 1, 0) <= l; f++);
                                        for (d = w((l - C(f, 0)) / 30.42); C(f, d + 1) <= l; d++);
                                        l = 1 + l - C(f, d), p = (c % 864e5 + 864e5) % 864e5, h = w(p / 36e5) % 24, m = w(p / 6e4) % 60, b = w(p / 1e3) % 60, p %= 1e3
                                    } else f = c.getUTCFullYear(), d = c.getUTCMonth(), l = c.getUTCDate(), h = c.getUTCHours(), m = c.getUTCMinutes(), b = c.getUTCSeconds(), p = c.getUTCMilliseconds();
                        ...
                        var L, E, T = o.fromCharCode,
                            ...
                            N = function B(e) {
                                ...
                                if ("$" == e && D(), "string" == typeof e) {
                                    ...
                                    if ("{" == e) {
                                        for (t = {};
                                            "}" != (e = R()); n || (n = !0)) n && ("," == e ? "}" == (e = R()) && D() : D()), "," != e && "string" == typeof e && "@" == (b ? e.charAt(0) : e[0]) && ":" == R() || D(), t[e.slice(1)] = B(R());
                                        return t
                                    }
                                    D()
                                }
    ...
    var u = n(6),
        ...
        l = n(34),
        s = r(l);
    o.VERSION = "0.13.0", (0, d["default"])(o, s["default"]), t["default"] = o
}, function(e, t, n) {
    "use strict";
        ...
        return o[t] = o[t] || function(n) {
            ...
            var l = function(n) {
                    var r = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : {},
                        o = (0, W["default"])(document.referrer),
                        c = {
                            track_id: t,
                            site: {
                    ...
                    o.surl && (c.page.ref_url = o.surl), o.bidId && (c.etx_id = o.bidId), B["default"].hasServiceOrigin() && (c.props.service_origin = B["default"].getServiceOrigin()), B["default"].isLimitAdTrackingEnabled() || (c.ad_id = f || B["default"].getAdId(), c.ad_id || (delete c.ad_id, delete c.lmt));
                    var d = B["default"].getKakaoAccountId();
                    d && (c.accid = d.trim());
                    var l = B["default"].getIDFV();
                    l && (c.props.idfv = l.trim());
                    var p = B["default"].getEncryptedKakaoAccountId();
                    return p && (c.eacid = p.trim()), (0, Y.fetchUserAgentData)().then(function(e) {
                        if (e) {
                            ...
                            1 === n.length ? (c.device.browser = n[0].brand, c.device.browser_version = n[0].version) : 1 === t.length && (c.device.browser = t[0].brand, c.device.browser_version = t[0].version), "platform" in e && e.platform && (c.device.os = e.platform), "platformVersion" in e && e.platformVersion && (c.device.os_version = e.platformVersion), "model" in e && e.model && (c.device.model = e.model), "mobile" in e && (c.device.is_mobile = e.mobile ? "Y" : "N", e.mobile ? (c.device.device_type = /iphone|ipad|ios/i.test(e.platform) ? "ios" : c.device.device_type, c.device.device_type = /android/i.test(e.platform) ? "android" : c.device.device_type) : c.device.device_type = "pc")
                        }
                        return (0, X["default"])()
                    }).then(function(e) {
                        return e.appKey && e.accessToken ? (c.props.app_key = e.appKey, c.props.app_access_token = e.accessToken, null === B["default"].getEncryptedKakaoAccountId() && (0, F["default"])(e)) : s["default"].resolve(null)
                    }).then(function(e) {
                        return e && (B["default"].setEncryptedKakaoAccountId(e), c.eacid = e), (0, i["default"])(a, c, {
                            param: "d",
                            callback: "c"
                        })
                    })["catch"](function() {
            ...
            return (0, c["default"])({
                track: p
            }, (0, g["default"])(p), (0, b["default"])(p), (0, k["default"])(p), (0, A["default"])(p), (0, S["default"])(p), (0, D["default"])(p), (0, N["default"])(p), (0, K["default"])(p), (0, y["default"])(p), (0, h["default"])(p), (0, L["default"])(p), (0, T["default"])(p))
        }, n.URL = n.URL || "https://bc.ad.daum.net/bc", n.VERSION = n.VERSION || "0.13.0", o[t](n)
    }
    ...
    function c(e) {
        ...
        var t = !1,
            ...
            o = function(e) {
                return clearTimeout(b), e instanceof Error || (e = e instanceof window.ProgressEvent ? 0 === e.target.status ? l ? new Error("XHR aborted network error") : new Error("XHR network error") : new Error("XHR error status " + e.target.status + " occured") : new Error("" + (e || "Unknown XMLHttpRequest Error"))), e.statusCode = 0, n(e, w)
            },
            i = function() {
                if (!l) {
                    var t = void 0;
                    clearTimeout(b), t = e.useXDR && c.status === undefined ? 200 : 1223 === c.status ? 204 : c.status;
                    var o = w,
                        u = null;
                    return 0 !== t ? (o = {
                        body: r(),
        ...
        if ("json" in e && !1 !== e.json && (m = !0, y.accept || y.Accept || (y.Accept = "application/json"), "GET" !== h && "HEAD" !== h && (y["content-type"] || y["Content-Type"] || (y["Content-Type"] = "application/json"), _ = JSON.stringify(!0 === e.json ? _ : e.json))), c.onreadystatechange = function() {
                ...
                l = !0
            }, c.ontimeout = o, c.open(h, s, !g, e.username, e.password), g || (c.withCredentials = !!e.withCredentials), !g && e.timeout > 0 && (b = setTimeout(function() {
                if (!l) {
                    l = !0, c.abort("timeout");
    ...
    for (var g = ["get", "put", "post", "patch", "head", "delete"], m = 0, b = g.length; m < b; m++) ! function(e, t) {
    ...
    function o() {
        ...
        return navigator.userAgentData && navigator.userAgentData.getHighEntropyValues ? (e("use `navigator.userAgentData.getHighEntropyValues`"), navigator.userAgentData.getHighEntropyValues(["fullVersionList", "platform", "platformVersion", "model"])) : i["default"].resolve(null)
    }
    t.__esModule = !0, t.fetchUserAgentData = o;
    var u = n(8),
        i = r(u),
        a = n(10),
        c = r(a)
