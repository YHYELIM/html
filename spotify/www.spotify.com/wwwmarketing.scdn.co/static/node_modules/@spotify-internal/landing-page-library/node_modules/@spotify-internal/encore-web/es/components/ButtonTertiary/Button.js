...
export var Button = styled( /*#__PURE__*/ React.forwardRef(function(_ref, ref) {
    ...
    var paddingStyles = css(["", " ", " ", " ", " ", ""], !condensedAll && css(["padding-block-start:", ";padding-block-end:", ";"], iconOnly ? iconOnlyPadding : paddingTopBottomComp, iconOnly ? iconOnlyPadding : paddingTopBottomComp), condensedAll && css(["padding:0;"]), condensed && css(["padding-inline-start:0;padding-inline-end:0;"]), !condensed && !condensedAll && !iconOnly && css(["padding-inline-start:", ";padding-inline-end:", ";"], iconLeading ? withIconPaddingLeftRight : paddingLeftRight, iconTrailing ? withIconPaddingLeftRight : paddingLeftRight), !condensed && !condensedAll && iconOnly && css(["padding-inline-start:", ";padding-inline-end:", ";"], iconOnlyPadding, iconOnlyPadding));
    ...
    var focusStyles = function focusStyles() {
        ...
        return css(["", ";&::after{inline-size:", ";}"], !useBrowserDefaultFocusStyle && focusBottomBorder(focusBorderBase, isUsingKeyboard, focus), focusBorderLength);
    };

    return css(["", " color:", ";min-inline-size:0;", ";", " &:hover{", "}", " &:active{", "}", " ", " &[disabled],&[aria-disabled='true'],fieldset[disabled] &{", "}"], buttonStylesBase(buttonSize, useBrowserDefaultFocusStyle, status), cssColorValue(semanticColor), paddingStyles, (iconLeading || iconTrailing) && css(["display:inline-flex;align-items:center;justify-content:center;"]), hoverStyles, hover && hoverStyles, activeStyles, active && activeStyles, focusStyles, disabledStyles);
});